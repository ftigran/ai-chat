...
export const MODELS: Model[] = [
  ...
  { id: "meta-llama/llama-4-scout-17b-16e-instruct", label: "Llama 4 Scout 17B", provider: "Groq", mcpDisabled: false },
  ...
  { id: "gemini-2.5-flash-lite", label: "Gemini 2.5 Flash Lite", provider: "Google", mcpDisabled: false },
  { id: "gemini-2.0-flash", label: "Gemini 2.0 Flash", provider: "Google", mcpDisabled: false },
  { id: "gemini-2.0-flash-lite", label: "Gemini 2.0 Flash Lite", provider: "Google", mcpDisabled: false },
];
